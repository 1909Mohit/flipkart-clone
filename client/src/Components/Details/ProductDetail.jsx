...
import { Box, Typography, TableBody, TableCell, Table, TableRow, styled } from '@mui/material';
    ...
    return (
        <>
            ...
            <Typography style={{ marginTop: 5, color: '#878787', fontSize: 14 }} >
                8 Ratings & 1 Reviews
                <Box><img src={fassured} style={{ width: 77, marginLeft: 20 }} alt='flipkartpoints' /></Box>
            </Typography>
            <Typography>
            ...
            <SmallText>
                ...
                <Typography><StyledBadge/>Get extra 13% off (proce inclusive of discount) T&C</Typography>
                ...
                <TableBody>
                    ...
                    <ColumnText>
                        ...
                        <TableCell>
                            ...
                            <Typography>View more sellers starting form ₹{ product.price.cost }</Typography>
                        </TableCell>
                    </ColumnText>
                    <ColumnText>
                        <TableCell colSpan={2}>
